...
int main(int argc, char *argv[])
{
    ...
    int init_num;     // randomized gonzalez init center num
    int farthest_num; // randomized gonzalez center num for every loop
    int select_num;   // randomized gonzalez new center num for every loop
    ...
    static const struct option longopts[] = {
        ...
        {"output_center", optional_argument, NULL, 'z'},
        {NULL, 0, NULL, 0}};
    ...
    case 9:
        ...
        break;
    case 10:
        DBSCAN_vanilla_angular(dim, n, MinPts, epsilon, input_fileName, output_data_filename, output_center_filename);
        break;
    case 11:
        DBSCAN_exact_angular(dim, n, MinPts, epsilon, rho, input_fileName, output_data_filename, output_center_filename);
        break;
    case 12:
        DBSCAN_approx_angular(dim, n, MinPts, epsilon, rho, input_fileName, output_data_filename, output_center_filename);
        break;
    }
